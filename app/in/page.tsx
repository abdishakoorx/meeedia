...
import { Camera, Upload, Sparkles, Grid3x3, ChevronRight, Info } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <header className="mb-12 text-center">
          ...
          >
            Create stunning videos with AI or from scratch. Choose your path and bring your vision to life.
          </motion.p>
        </header>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <CreationCard
            icon={<Sparkles className="w-12 h-12 text-purple-600 dark:text-purple-400" />}
          ...
          {/* Templates Card */}
          <CreationCard
            icon={<Grid3x3 className="w-12 h-12 text-green-600 dark:text-green-400" />}
...
const CreationCard: React.FC<CreationCardProps> = ({ icon, title, description, buttonText, buttonColor, newUserTip }) => {
  return (
    <motion.div 
    ...
    >
      ...
      <Button className={`w-full ${buttonColor} text-white py-2 rounded-lg transition-colors duration-200 text-sm font-medium`}>
        {buttonText}
      </Button>
    </motion.div>
  )
