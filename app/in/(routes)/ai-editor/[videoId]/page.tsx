...
import EditingField from "../../scratch-editor/_components/EditingField";
import UpdateFrameList from "../../scratch-editor/[videoId]/_components/UpdateFrameList";
import UpdatedRemotePlayer from "../../scratch-editor/[videoId]/_components/UpdateRemotionPlayer";

export default function AISavedVideoEditor() {
