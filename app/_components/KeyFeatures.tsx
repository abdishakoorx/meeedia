...
import { Palette, Layout, Wand2, Layers, Cpu, Edit, Paintbrush, Zap } from 'lucide-react';
...
function FeatureItem({ icon, title, description, index }: FeatureItemProps) {
  return (
    ...
    >
      ...
      <h4 className="text-xl font-semibold mb-2 text-gray-800 dark:text-gray-100">{title}</h4>
...
export default function KeyFeatures() {
  ...
  return (
    <section className="py-20 rounded-2xl mt-4 px-6 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Discover the powerful tools that will revolutionize your video creation process.
          </p>
        </motion.div>
