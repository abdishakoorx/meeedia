    ...
    <footer className="bg-gray-900 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/#" className="hover:text-purple-400">Enterprise</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/#" className="hover:text-purple-400">Tutorials</Link></li>
              <li><Link href="/#" className="hover:text-purple-400">Guides</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/#" className="hover:text-purple-400">Press</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm">
          <p>&copy; 2025 Meeedia. All rights reserved.</p>
